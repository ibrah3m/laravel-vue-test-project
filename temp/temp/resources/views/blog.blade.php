...
<head>
    ...
    <link href="{{ asset('css/CustomComments.css') }}" rel="stylesheet">
        ...
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                <div class="post-heading">
                    ...
                    <h2 class="subheading">Problems look mighty small from 150 miles up</h2><span class="meta">Posted by&nbsp;<a
                            href="#">Start Bootstrap</a>&nbsp;on August 24, 2018</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                ...
                <blockquote class="blockquote">
                    <p class="mb-0">The dreams of yesterday are the hopes of today and the reality of tomorrow. Science
                        has not yet mastered prophecy. We predict too much for the next year and yet far too little for
                        the next ten.</p>
                </blockquote>
                ...
                <p>As we got further and further away, it [the Earth] diminished in size. Finally it shrank to the size
                    ...
                    this has to change a man.</p><a href="#"><img class="img-fluid"
                                                                  src="{{ asset('images/post-sample-image.jpg') }}"></a><span
                    class="text-muted caption">To go places and do things that have never been done before – that’s what living is all about.</span>
...
<div id="app">
    <section>
        <div class="container my-5 py-5 rounded " style="background-color: #f7f6f6;">
            <div class="row d-flex justify-content-center">
                <div class="col-md-12 col-lg-10 col-xl-8">

                    <div class="row">
            {{-- this is where we trigger the main component which handle the box of the comments and the sub-components too --}}
